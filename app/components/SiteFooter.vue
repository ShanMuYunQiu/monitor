  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> 山暮云秋 &amp imsyy </n-text>
...
const linkData = {
  github: "https://github.com/ShanMuYunQiu",
  home: "https://www.muyun.space",
  email: "mailto:lty15376767691@gmail.com",
};
</script>
